...
export function NotFound() {
  return (
    <>
      <Helmet>
        <title>404 - Page Not Found | SoleChem</title>
        <meta name="description" content="The page you are looking for could not be found. Browse our product catalog or contact us for assistance." />
